  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name='description' content='Welcome to my Porfolio website.' />
        <link rel='icon' href='/favicon.ico' />
        <style>
          @import
          url('https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@200;400;600;700&display=swap');
        </style>
      </Head>
      <CodeBackground />
      <Header />
      <main className={styles.main}>
        <img src='/img/showcase.svg' alt='Showcase Image' />
        <div>
          <h1>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.grid}>
          ...
          <div>
            <img src='/img/Users.svg' alt='Websites' className={styles.image} />
            <h3>Over 500 Site Users</h3>
          </div>
          <div>
            <img src='/img/Form.svg' alt='Websites' className={styles.image} />
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionLead}>
          ...
          your{" "}
          <a href='' title='Get your free site quote!'>
            free site quote
          </a>{" "}
