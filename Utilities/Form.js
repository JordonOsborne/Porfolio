...
export function NewUserIsValid(FirstName, LastName, Password, PasswordConfirmation) {
  let errors = []
...
export async function RegisterWithEmail(FirstName, LastName, Phone, Email, Password){
...
export async function RegistrationSuccess(user, FirstName, LastName, Phone, Email) {
  const formUser = {
