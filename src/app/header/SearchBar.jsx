	...
	return (
		<div className='relative hidden lg:block'>
			...
			<input
				...
				className='p-[2px] pl-9 text-sm font-extralight rounded-full w-80 border-[1px] border-neutral-700 dark:border-neutral-800 focus:outline-none bg-neutral-600 dark:bg-neutral-900 placeholder:italic placeholder:text-dark dark:placeholder:text-light'
